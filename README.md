...
🚨**Disclaimers:**
* We were able to only monitor, Light, humidity and temperature. CO₂ and O2 sensors were simulated using Potentiometers and code that set out to “fake” CO₂ and O2 data.
...
In addition The system as it stands lacks the integration of CO2 and O2 sesnors, in order to deal with that we used 2 potentiometers that are programmed to feed “fake” CO₂ and O2 data so that we have a way to control the pumps and something to show in the presentation.
